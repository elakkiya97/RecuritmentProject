...
const Job = ({handleNext, handleBack,currentStep}) => {
    ...
    const handleSubmit2 = async (e) => {
        ...
        if (!Object.values(ExperienceData).every(value => value)) {
          ...
          // Check if any of the education data fields are empty
    ...
    console.log('[additionalLanguageOptions', additionalLanguageOptions)
    useEffect(() => {
        const fetchSkills = async () => {
            try {
                ...
                if (Array.isArray(skillData)) {
                    ...
                    const additionalLanguages = skillData.filter(skill => skill.skillType === 0);
                    ...
                    console.log('Additional Languages:', additionalLanguages);
                    console.log('Soft Skills:', softSkills);
                    console.log('Hard Skills:', hardSkills);
                } else {
                    console.error("Error fetching skills: Response data is not an array", response);
                }
            } catch (error) {
           ...
           <Row gutter={[24, 24]}>
                ...
                <Col span={12}>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                handleChangeExperienceData("additionalQualification", e.target.value)
                            }
                            className="form-control"
                ...
                <Col span={12}>
                        ...
                        <Select
                            ...
                            placeholder="additionalKnownLanguages"
                        >
